...
| `CRED_GSHEETS` | OAuth2 do Google com acesso à planilha de espelho | Google Cloud Console → OAuth2, ou conta Google já usada pelo n8n | n8n → Credentials → New → "Google Sheets OAuth2 API" → nome exato `CRED_GSHEETS` | W5 |
